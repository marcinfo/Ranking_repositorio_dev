# Generated by Django 4.2.4 on 2023-11-03 15:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('r_m', models.CharField(choices=[('I', 'Interior'), ('M', 'Metropolitana')], max_length=1, verbose_name='Diretoria:')),
                ...
                ('numemro_contrato', models.CharField(max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idg_interior', models.DecimalField(decimal_places=2, help_text='INDICE DE DESEMPENHO GLOBAL (IDG)', max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ...
                ('quantidade_colaboradores', models.IntegerField(blank=True)),
                ('acidente_trabalho', models.DecimalField(decimal_places=2, default=0, help_text='ACIDENTE DE TRABALHO (Quantidade)', max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('justificativa', models.TextField(blank=True, help_text='Justifique os indicadores informados.', max_length=500)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inserido_por', models.CharField(max_length=100)),
                ('contrato', models.CharField(max_length=20)),
                ('idg', models.DecimalField(decimal_places=2, help_text='INDICE DE DESEMPENHO GLOBAL (IDG)', max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ...
                ('entrega_cadastro', models.DecimalField(decimal_places=2, help_text='ENTREGA DO CADASTRO E IMOBILIZAÇÃO', max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('seg_capacitacao', models.DecimalField(decimal_places=2, max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='SEGURANÇA E CAPACITAÇÃO')),
